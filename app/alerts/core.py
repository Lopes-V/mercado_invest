...
class AlertService:
    ...
    def send(self, *, asset_id: UUID, opportunity_id: UUID, recipient_id: int, recipient_authorized: bool, level: OpportunityLevel, quality: DataQuality, decided_at: datetime, asset: str, timestamp: datetime, price: Decimal, score: Decimal, factors: tuple[str,...]=(), risks: tuple[str,...]=()):
        ...
        decision=self._engine.decide(level=level,quality=quality,last_sent_at=last_sent,decided_at=decided_at,recipient_authorized=recipient_authorized)
